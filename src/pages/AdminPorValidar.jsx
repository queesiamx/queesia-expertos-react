...
export default function AdminPorValidar() {
  ...
  return (
    <>
      ...
      <AdminShell
        title="Respuestas por validar"
        subtitle="Revisa respuestas enviadas por expertos antes de publicarlas."
        sidebarProps={{
          expertosCount: 0,
          aprobadosCount: 0,
          pendientesExpertosCount: 0,
          consultasPendientesCount: 0,
          porValidarCount: consultas.length,
          resueltasGratisCount: 0,
          conCobroCount: 0,
        }}
      >
        <AdminSectionHeader title="Respuestas pendientes por validar" />
